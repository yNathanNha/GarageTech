...
public class NTCreativeTabs {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.garagetech")).icon(() -> NTItems.EXAMPLE_ITEM.get().getDefaultInstance()).displayItems((parameters, output) -> {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> ORES_TAB = CREATIVE_MODE_TABS.register("ores_tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.garagetech.ores")).icon(() -> NTItems.INGOTS.get(Element.ALUMINUM).asItem().getDefaultInstance()).displayItems((parameters, output) -> {
