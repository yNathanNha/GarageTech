// src/main/java/me/nathan/neotest/item/tool/MultiLayerToolItem.java
package me.nathan.neotest.item.custom;
...
public class BaseDust extends Item {
    ...
    public BaseDust(Element material, String itemType) {
